...
inline void saveAllWorlds() // 
{
	...
	Sleep(200);
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`9GrowSand`w] `2Saved `oall worlds``"));
	...
	if (static_cast<PlayerInfo*>(peer->data)->haveGrowId)
	{
		if (static_cast<PlayerInfo*>(peer->data)->rawName == getPlyersWorld(peer)->owner)
		{
			...
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 4)
			{
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`#MOD`w]`#@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". `2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "`2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
		...
		else
		{
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 4)
			{
				...
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`#MOD`w]`#@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". " + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`#MOD`w]`#@" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
			}
		}
	}
	...
	if (static_cast<PlayerInfo*>(peer->data)->haveGrowId)
	{
		if (static_cast<PlayerInfo*>(peer->data)->rawName == getPlyersWorld(peer)->owner)
		{
			...
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 5)
			{
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`2ADMIN`w]`2@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". `2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "`2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
		...
		else
		{
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 5)
			{
				...
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`2ADMIN`w]`2@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". " + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`2ADMIN`w]`2@" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
			}
		}
	}
	...
	if (static_cast<PlayerInfo*>(peer->data)->haveGrowId)
	{
		if (static_cast<PlayerInfo*>(peer->data)->rawName == getPlyersWorld(peer)->owner)
		{
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 6)
			{
				...
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`bDev`w]`b@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". `2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "`2" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
		...
		else
		{
			if (static_cast<PlayerInfo*>(peer->data)->adminLevel == 6)
			{
				...
				if (static_cast<PlayerInfo*>(peer->data)->NickPrefix != "")
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`bDev`w]`b@" + static_cast<PlayerInfo*>(peer->data)->NickPrefix + ". " + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
				else
				{
					static_cast<PlayerInfo*>(peer->data)->displayName = "[`bDev`w]`b@" + static_cast<PlayerInfo*>(peer->data)->tankIDName;
				}
			}
		}
	}
...
inline void autoSaveWorlds() {
	while (1) {
		...
		GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`9GrowSand`w] `5Auto Saving All Worlds..."));
		ENetPacket* packet = enet_packet_create(p.data,
			p.len,
			ENET_PACKET_FLAG_RELIABLE);
		enet_host_broadcast(server, 0, packet);
